# USAGE: Start BLOC-service as you usually would
...
from bloc import Walletd as Wallet
import time
import argparse
parser = argparse.ArgumentParser()
parser.add_argument("--address", help="BLOC address to optimize", required=True)
