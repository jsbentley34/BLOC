...
function usage()
{
    ...
    echo "and generates the checksum files of the BLOC tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/furiousteam/BLOC.git"
CLONE_DIR="$BUILD_DIRECTORY/bloc-buildall"
TARGET_DIR="$BUILD_DIRECTORY/bloc-releases"
DYNAMIC_RELEASE="bloc-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="bloc-${TAG_VERSION}-linux-staticboost-CLI"
